...
function Obra() {
    ...
    this.andamento = "";//Tipos de andamento: criada , iniciada , concluida , interrompida
...
// }
    ...
    this.setAndamento = function (andamento) {andamento != "criada" && andamento != "iniciada" && andamento != "concluida" && andamento != "cancelada" && andamento != "pausada"
        if(andamento != "criada" 
            && andamento != "iniciada"
            && andamento != "concluida"
            && andamento != "cancelada"
