function Alerta() {
    ...
    this.abrirErroValidacao = function () {
        if (valida.email == false) {
            //aparece mensagem campo incorreto
        } else if (valida.senha == false) {
            //aparece mensagem campo incorreto
        } else if (valida.data == false) {
            //aparece mensagem campo incorreto
        } else if (valida.hash == false) {
            //aparece mensagem campo incorreto
        } else {
            console.log("Nenhum parâmetro foi verificado");
        }
    }
