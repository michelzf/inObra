function funcionalidadesDisponiveis() {
    ...
    if (typeof document.getElementsByTagName("body")[0].firstChild == "undefined" || typeof document.getElementsByTagName("body")[0].removeChild == "undefined") {
        window.top.location = "indisponivel.html";
        funcionalidadesDisponiveis = false;
    }
    if (typeof document.getElementsByTagName("body")[0].remove != typeof Function) {
    ...
    if (typeof document.getElementsByTagName("body")[0].empty != typeof Function) {
    ...
    if (document.getElementsByTagName("body")[0].style.display != "flex") {
        document.getElementsByTagName("body")[0].style.display = "-webkit-flex";
        if (document.getElementsByTagName("body")[0].style.display != "-webkit-flex") {
            document.getElementsByTagName("body")[0].style.display = "-moz-flex";
            if (document.getElementsByTagName("body")[0].style.display != "-moz-flex") {
    ...
    if (!funcionalidadesDisponiveis) {
        window.alert("" +
            "Aviso: O WebApp não é compatível 100% com seu dispositivo. Por isso, algumas funcionalidades ou estilos do app podem não funcionar corretamente.\n\n" +
            "Isso acontece devido a versão do seu dispositivo / navegador não estar de acordo com os padrões Web mais recentes.\n\n" +
            "Para mais informações consulte o administrador do WebApp");
    } else {
        console.log("Seu navegador possui todas as funcionalidades utilizadas pelo WebApp.");
    }
}